...
#define MAIN_SHIP_DEFAULT_NAME "USS Queeqeg"
#define SHIP_MAP_NAMES list("USS Almayer", "USS Queeqeg",  "USS Golden Arrow (Classic)", "SSV Chapaev", "USS Rover", "USCSS Firefly")
